...
# 23 "TempControl.asm" 2

;----------------
; PROGRAM INPUTS
;----------------
measuredTempInput equ 12 ; Input for measured from sensor
refTempInput equ 13 ; Input from user
NUME equ 0x22
QU equ 0x23
MYDEN equ 10
;----------------
...
LED_HOT:
 BSF PORTD,2 ; Sets PORTD 2 to the heater LED
 MOVLW 2h
 MOVWF contReg
 GOTO TempCheck

LED_COOL:
 BSF PORTD,1 ; Sets PORTD 1 to the coller LED
 MOVLW 1h
 MOVWF contReg
 GOTO TempCheck

LED_OFF:
 BCF PORTD,1 ; Sets PORTD 1 to the coller LED, 0 ; Clear PORTD,1 (Cooling LED)
 BCF PORTD,2 ; Sets PORTD 2 to the heater LED, 0 ; Clear PORTD,2 (Heater LED)
 MOVLW 0h
 MOVWF contReg
 GOTO TempCheck
